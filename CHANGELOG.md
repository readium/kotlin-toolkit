...
* The new reflowable Web navigator accepts custom JavaScript interfaces through `ReflowableWebConfiguration.javascriptInterfaces`, mirroring `EpubNavigatorFragment.Configuration.registerJavascriptInterface` in the legacy navigator.
