...
class ReaderRepository(
    ...
    private suspend fun openVisual(
        ...
        when {
            publication.readingOrder.allAreBitmap || publication.readingOrder.allAreHtml ->
                openVisualCompose(bookId, publication, initialLocator)
            else ->
                openVisualOld(bookId, publication, initialLocator)
            }

    private suspend fun openVisualCompose(
        bookId: Long,
        publication: Publication,
        initialLocator: Locator?
