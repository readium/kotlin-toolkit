...
abstract class AbstractServer(private var port: Int) : RouterNanoHTTPD(port) {
    ...
    fun loadResources(assets: AssetManager, context: Context) {
        ...
        addResource("rtl-default.css", Scanner(assets.open("ReadiumCSS/rtl/ReadiumCSS-default.css"), "utf-8")
                .useDelimiter("\\A").next())
        addResource("cjk-vertical-after.css", Scanner(assets.open("ReadiumCSS/cjk-vertical/ReadiumCSS-after.css"), "utf-8")
                .useDelimiter("\\A").next())
        addResource("cjk-vertical-before.css", Scanner(assets.open("ReadiumCSS/cjk-vertical/ReadiumCSS-before.css"), "utf-8")
                .useDelimiter("\\A").next())
        addResource("cjk-vertical-default.css", Scanner(assets.open("ReadiumCSS/cjk-vertical/ReadiumCSS-default.css"), "utf-8")
                .useDelimiter("\\A").next())
        addResource("cjk-horizontal-after.css", Scanner(assets.open("ReadiumCSS/cjk-horizontal/ReadiumCSS-after.css"), "utf-8")
                .useDelimiter("\\A").next())
        addResource("cjk-horizontal-before.css", Scanner(assets.open("ReadiumCSS/cjk-horizontal/ReadiumCSS-before.css"), "utf-8")
                .useDelimiter("\\A").next())
        addResource("cjk-horizontal-default.css", Scanner(assets.open("ReadiumCSS/cjk-horizontal/ReadiumCSS-default.css"), "utf-8")
                .useDelimiter("\\A").next())
