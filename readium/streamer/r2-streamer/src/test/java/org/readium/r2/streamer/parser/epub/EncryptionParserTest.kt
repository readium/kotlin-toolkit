...
class EncryptionParserTest {
    ...
    val lcpChap1 = entry("/chapter01.xhtml", Encryption(
    ...
    val lcpChap2 =  entry("/dir/chapter02.xhtml", Encryption(
        algorithm = "http://www.w3.org/2001/04/xmlenc#aes256-cbc",
        compression = "none",
    ...
    fun `Check EncryptionParser with unknown retrieval method`() {
        assertThat(parseEncryption("encryption/encryption-unknown-method.xml")).contains(
            entry("/html/chapter.html", Encryption(
                algorithm = "http://www.w3.org/2001/04/xmlenc#kw-aes128",
                compression = "deflate",
                originalLength = 12914,
                profile = null,
                scheme = null )),
            entry("/images/image.jpeg", Encryption(
                algorithm = "http://www.w3.org/2001/04/xmlenc#kw-aes128",
                compression = null,
                originalLength = null,
                profile = null,
