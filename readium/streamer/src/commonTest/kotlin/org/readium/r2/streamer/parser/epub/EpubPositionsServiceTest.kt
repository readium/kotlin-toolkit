...
class EpubPositionsServiceTest {
    ...
    @Test
    fun `type fallbacks on text-html`() = runTest {
        val service = createService(
            readingOrder = listOf(
    ...
    @Test
    fun `One position per fixed-layout resources`() = runTest {
        val service = createService(
            layout = Layout.FIXED,
            readingOrder = listOf(
    ...
    @Test
    fun `Split reflowable resources by the provided number of bytes`() = runTest {
        val service = createService(
    ...
    @Test
    fun `layout fallbacks to reflowable`() = runTest {
    ...
    @Test
    fun `Use the ArchiveEntryLength reflowable strategy`() = runTest {
        val service = createService(
            layout = Layout.REFLOWABLE,
            readingOrder = listOf(
        ...
        assertEquals(
            ...
            service.positionsByReadingOrder()
        )
    }

    @Test
    fun `Use the OriginalLength reflowable strategy`() = runTest {
        val service = createService(
            layout = Layout.REFLOWABLE,
            readingOrder = listOf(
