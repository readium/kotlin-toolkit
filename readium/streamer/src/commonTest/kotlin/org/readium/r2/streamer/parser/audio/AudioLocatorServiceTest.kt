...
class AudioLocatorServiceTest {
    ...
    @Test
    fun `locateLocator matching reading order HREF`() = runTest {
    ...
    @Test
    fun `locateLocator returns null if no match`() = runTest {
        val service = AudioLocatorService(
            listOf(
                Link(Href("l1")!!),
                Link(Href("l2")!!)
    ...
    @Test
    fun `locateLocator uses totalProgression`() = runTest {
        val service = AudioLocatorService(
            listOf(
    ...
    @Test
    fun `locateLocator using totalProgression keeps title and text`() = runTest {
        val service = AudioLocatorService(
            listOf(
                Link(Href("l1")!!, mediaType = MediaType.MP3, duration = 100.0),
                Link(Href("l2")!!, mediaType = MediaType.MP3, duration = 100.0)
    ...
    @Test
    fun `locate progression`() = runTest {
        val service = AudioLocatorService(
            listOf(
                Link(Href("l1")!!, mediaType = MediaType.MP3, duration = 100.0),
                Link(Href("l2")!!, mediaType = MediaType.MP3, duration = 100.0)
    ...
    @Test
    fun `locate invalid progression`() = runTest {
        val service = AudioLocatorService(
            listOf(
                Link(Href("l1")!!, mediaType = MediaType.MP3, duration = 100.0),
                Link(Href("l2")!!, mediaType = MediaType.MP3, duration = 100.0)
