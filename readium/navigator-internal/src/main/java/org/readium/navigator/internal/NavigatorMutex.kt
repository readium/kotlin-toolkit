...
class NavigatorMutex {
    ...
    private val mutator: org.readium.navigator.internal.util.MutatorMutex<Priority> =
        org.readium.navigator.internal.util.MutatorMutex()
    ...
    suspend fun<R> absoluteGo(block: suspend () -> R): R {
        ...
        } catch (e: org.readium.navigator.internal.util.MutatorMutex.LockException.CannotInterrupt) {
            Timber.e(e, "Restarting go.")
            absoluteGo(block)
        } catch (e: org.readium.navigator.internal.util.MutatorMutex.LockException.Interrupted.HigherPriority) {
            Timber.e(e,"Restarting go. ${mutator.mutex.isLocked}")
            absoluteGo(block)
        } catch (e: org.readium.navigator.internal.util.MutatorMutex.LockException.Interrupted.SamePriority) {
