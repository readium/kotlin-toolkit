...
internal class IntervalList<T> {
    private val intervals = mutableListOf<org.readium.navigator.internal.lazy.IntervalHolder<T>>()
    ...
    fun add(size: Int, content: T) {
        ...
        val interval = org.readium.navigator.internal.lazy.IntervalHolder(
     ...
     */
    private fun findIndexOfHighestValueLesserThan(list: List<org.readium.navigator.internal.lazy.IntervalHolder<T>>, value: Int): Int {
        var left = 0
