...
internal fun snapFlingBehavior(
...
private class SnapFlingBehavior(
    ...
    override suspend fun ScrollScope.performFling(
        ...
        /**
         * We definitely need to propagate the remaining velocity because nested scroll connections
         * might want to use it.
         */
        return remainingState.velocity
