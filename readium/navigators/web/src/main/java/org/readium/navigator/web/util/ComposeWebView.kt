...
internal open class AccompanistWebViewClient : WebViewClient() {
    internal open lateinit var state: WebViewState
        internal set
    internal open lateinit var navigator: WebViewNavigator
        internal set
...
internal sealed class WebContent {
    ...
    internal data object NavigatorOnly : WebContent()
}
...
internal sealed class LoadingState {
     ...
     */
    internal data class Loading(val progress: Float) : LoadingState()
...
internal class WebViewState(webContent: WebContent) {
     ...
     */
    internal var pageTitle: String? by mutableStateOf(null)
        internal set

    /**
     * the favicon received from the loaded content of the current page
     */
    internal var pageIcon: Bitmap? by mutableStateOf(null)
        internal set
...
internal class WebViewNavigator(private val coroutineScope: CoroutineScope) {
    ...
    internal fun loadUrl(url: String, additionalHttpHeaders: Map<String, String> = emptyMap()) {
 ...
 */
@Composable
internal fun rememberSaveableWebViewState(): WebViewState =
