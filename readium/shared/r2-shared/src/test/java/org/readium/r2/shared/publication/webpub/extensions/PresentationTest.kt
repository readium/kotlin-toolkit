...
class PresentationTest {
    ...
    @Test
    fun `parse orientation from JSON value`() {
    ...
    @Test
    fun `get orientation JSON value`() {
    ...
    @Test
    fun `parse overflow from JSON value`() {
    ...
    @Test
    fun `parse page from JSON value`() {
    ...
    @Test
    fun `parse spread from JSON value`() {
    ...
    @Test
    fun `get Properties {fit} when available`() {
        assertEquals(
    ...
    @Test
    fun `get Properties {fit} when missing`() {
        assertEquals(Presentation.Fit.CONTAIN, Properties().fit)
    }

    @Test
    fun `get Properties {orientation} when available`() {
        assertEquals(
    ...
    @Test
    fun `get Properties {orientation} when missing`() {
        assertEquals(Presentation.Orientation.AUTO, Properties().orientation)
    }

    @Test
    fun `get Properties {overflow} when available`() {
        assertEquals(
    ...
    @Test
    fun `get Properties {overflow} when missing`() {
        assertEquals(Presentation.Overflow.AUTO, Properties().overflow)
    }

    @Test
    fun `get Properties {page} when available`() {
        assertEquals(
    ...
    @Test
    fun `get Properties {page} when missing`() {
        assertNull(Properties().page)
    }

    @Test
    fun `get Properties {spread} when available`() {
        assertEquals(
    ...
    @Test
    fun `get Properties {spread} when missing`() {
