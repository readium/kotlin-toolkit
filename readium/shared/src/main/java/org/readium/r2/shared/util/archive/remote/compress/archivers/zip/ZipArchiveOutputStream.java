 ...
 *
 */
package org.readium.r2.shared.util.archive.remote.compress.archivers.zip;

import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.DATA_DESCRIPTOR_MIN_VERSION;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.DEFLATE_MIN_VERSION;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.DWORD;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.INITIAL_VERSION;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.SHORT;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.WORD;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.ZIP64_MAGIC;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.ZIP64_MAGIC_SHORT;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipConstants.ZIP64_MIN_VERSION;
import static org.readium.r2.shared.util.archive.remote.compress.archivers.zip.ZipLong.putLong;

import org.readium.r2.shared.util.archive.remote.compress.archivers.ArchiveEntry;
import org.readium.r2.shared.util.archive.remote.compress.archivers.ArchiveOutputStream;
