...
class PublicationTest {
    ...
    @Test fun `get {pageList}`() {
        val links = listOf(Link(href = urlHref("/page1.html")))
        assertEquals(
            links,
            createPublication(
    ...
    @Test fun `get {landmarks}`() {
        val links = listOf(Link(href = urlHref("/landmark.html")))
        assertEquals(
            links,
            createPublication(
                subcollections = mapOf(
    ...
    @Test fun `get {listOfAudioClips}`() {
        val links = listOf(Link(href = urlHref("/audio.mp3")))
        assertEquals(
            links,
            createPublication(
                subcollections = mapOf(
    ...
    @Test fun `get {listOfIllustrations}`() {
        val links = listOf(Link(href = urlHref("/image.jpg")))
        assertEquals(
            links,
            createPublication(
                subcollections = mapOf(
    ...
    @Test fun `get {listOfTables}`() {
        val links = listOf(Link(href = urlHref("/table.html")))
        assertEquals(
            links,
            createPublication(
                subcollections = mapOf(
    ...
    @Test fun `get {listOfVideoClips}`() {
        val links = listOf(Link(href = urlHref("/video.mov")))
        assertEquals(
            links,
            createPublication(
                subcollections = mapOf(
