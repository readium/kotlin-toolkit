...
public data class Presentation(
    ...
    override fun toJSON(): JsonObject = buildJsonObject {
        putIfNotNull("clipped", clipped)
        putIfNotNull("continuous", continuous)
        putIfNotNull("fit", fit?.value)
        putIfNotNull("orientation", orientation?.value)
        putIfNotNull("overflow", overflow?.value)
        putIfNotNull("spread", spread?.value)
