...
public data class Link(
    ...
    override fun toJSON(): JsonObject = buildJsonObject {
        ...
        putIfNotNull("type", mediaType?.toString())
    ...
    public companion object {
        ...
        private fun parseHref(
            ...
            if (hrefString == null) {
                warnings?.log(Link::class, "[href] is required", json)
                return null
            }
            ...
            if (href == null) {
                warnings?.log(Link::class, "[href] is not a valid URL or URL template", json)
            }
