...
public data class Encryption(
    ...
    override fun toJSON(): JsonObject = buildJsonObject {
        ...
        putIfNotNull("compression", compression)
        putIfNotNull("originalLength", originalLength)
        putIfNotNull("profile", profile)
    ...
    public companion object {
        ...
        public fun fromJSON(json: JsonObject?, warnings: WarningLogger? = null): Encryption? {
            ...
            if (algorithm.isNullOrEmpty()) {
                warnings?.log(Encryption::class, "[algorithm] is required", json)
                return null
            }
