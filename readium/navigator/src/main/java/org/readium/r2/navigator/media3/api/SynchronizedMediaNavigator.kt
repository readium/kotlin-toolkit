...
interface SynchronizedMediaNavigator<L : SynchronizedMediaNavigator.Location, P : SynchronizedMediaNavigator.Playback,
    R : SynchronizedMediaNavigator.ReadingOrder> : MediaNavigator<L, P, R> {
